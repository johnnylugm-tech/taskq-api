...
| ID | Spec Description | Intent Class | Decision Framework | Owner | Source | Status | Notes |
|----|------------------|--------------|--------------------|-------|--------|--------|-------|
| OOS-01 | TypeScript round 3 (deferred per PROJECT_BRIEF §Stakeholders) | Out of scope: language round | Defer | Project Sponsor | SPEC.md / PROJECT_BRIEF | Deferred | Round 3 not in this round's canonical |
| OOS-02 | FR beyond FR-10 (user management, RBAC beyond three scopes, multi-tenancy) | Out of scope: feature creep | Reject | Project Sponsor | SPEC.md §3 | Deferred | Not in canonical |
| OOS-03 | Alembic revision beyond v3 (no v4, no DB sharding) | Out of scope: migration roadmap | Reject | Project Sponsor | SPEC.md §3 FR-07 | Deferred | Three-revision line fixed |
| OOS-04 | Anything not in SPEC §3 / §4 / §5.1 / §5.2 / §5.3 / §6 / §7 / §8 / §9 | Out of scope: non-canonical surface | Reject | Project Sponsor | SPEC.md (all sections) | Deferred | Silent omission per SRS §6 |
